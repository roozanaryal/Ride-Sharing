    ...
    >
      <div className="max-w-xl mx-auto px-6">
        ...
        <div className="relative space-y-3">
          ...
          {/* Find Trip Button inside the input section when open and both fields filled */}
          {isPanelOpen && pickup && destination && (
            <button
              onClick={onFindTrip}
              className="w-full bg-black text-white font-bold py-4 rounded-2xl shadow-lg active:scale-[0.98] transition-all animate-in fade-in zoom-in-95 duration-300"
            >
              Find Trip
            </button>
          )}
